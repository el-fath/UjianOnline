  ...
  <div class="wrap p-t-0">
    <footer class="app-footer">
      <div class="clearfix">
        <div class="copyright pull-left">Rochman El-fath</div>
      </div>
    </footer>
  </div>
  <!-- /#app-footer -->
...
<!--========== END app main -->
	...
	<script src="<?php echo base_url(); ?>assets/datatable/dt/dataTables.bootstrap.js" type="text/javascript"></script>
	...
	<!-- <script rel="stylesheet" href="<?php echo base_url(); ?>assets/assets/libs/misc/datatables/datatables.min.js"></script> -->
