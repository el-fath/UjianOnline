  ...
  <div class='container'>
    <div class='panel panel-primary dialog-panel'>
      <div class='panel-heading'>
        <h4 align="center">Form Pendaftaran Untuk Mahasiswa</h4>
      </div>
      <div class='panel-body'>
        <form class='form-horizontal' action="<?php echo base_url('dosen/tambah') ?>" method="POST" enctype="multipart/form-data">
