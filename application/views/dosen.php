  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          NIDN
          <input type="text" class="form-control input-sm" required="" placeholder="" name="id_dosen">
          Nama
			...
			<div class="col-md-12">
				<div class="widget widget-pie-chart">
					...
					<div class="table-responsive">
						<table id="table_dosen" border="1" class="table table-bordered table-striped table-hover">
						<thead>
            <tr>
            <th>Id Dosen</th>
            <th>Nama Dosen</th>
